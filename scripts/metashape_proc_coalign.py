...
def camera_filtering(rgb_chunk, multispec_chunk):
    ...
    # Batch remove cameras (assuming Metashape API supports list operations)
...
def calibrate_reflectance_and_transform(multispec_chunk, multispec_sensors, doc, args):
    """
...
def resume_proc():
    ...
    if not rgb_chunk:
        raise ValueError("RGB chunk not found")
